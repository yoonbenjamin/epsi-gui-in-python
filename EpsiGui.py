...
#
# Version: 1.0 (Author: Benjamin (Ben) Yoon; Date: Mon, Aug 14, 2023)
...
#
# Version: 1.1 (Author: Benjamin (Ben) Yoon; Date: Fri, Sep 29, 2023)
# General bugs fixed, global contrast implemented, variables the user may want to change moved to the top of the code, 
# sliders replaced with buttons, color map speed improved--only finds color map coordinates once (fun split into multiple 
# functions), general speed increase (remove previous plots), & code restructured to move certain functions into EpsiHelpers.
#
# Version 1.2 
# Allows users to choose base folder path for EPSI data & DICOM files, 
#
...
class EpsiGui:
    ...
    #  @version 1.2
    #
    #  @param folder_path_base Path to the base folder containing EPSI data and DICOM files.
    def __init__(self, folder_path_base):
        # USER SHOULD CHANGE THE IMMEDIATELY FOLLOWING VARIABLES TO MATCH DESIRED EXPERIMENT
        self.plot_shift = [-0.3, -0.4]
        self.info_epsi = {
        ...
        self.columns = 16
        self.rows = 12
        self.coordinates_axis_plot = (14, 233, 51, 215)
        self.epsi_data_sets = 17
        self.proton_pictures = 20
        ...
        self.path_dmc = folder_path_base + "/fsems_rat_liver_03.dmc/"
        self.path_fid = folder_path_base + "/fsems_rat_liver_03"
        self.path_13c = folder_path_base + "/epsi_16x12_13c_"
        self.path_epsi = ""
        ...
        # VERSION 1.1
        self.current_value_image_slice = int((self.proton_pictures - 1) / 2)
